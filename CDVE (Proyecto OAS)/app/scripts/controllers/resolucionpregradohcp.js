...
/**
 * @ngdoc function
 * @name cdveApp.controller:ResolucionpregradohcpCtrl
 * @description
 * # ResolucionpregradohcpCtrl
 * Controller of the cdveApp
 */
angular.module('cdveApp')
  .controller('ResolucionpregradohcpCtrl', function (vinculacion_request,$routeParams) {
    var self = this;
