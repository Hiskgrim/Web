...
/**
 * @ngdoc function
 * @name cdveApp.controller:ResolucionposgradohcpCtrl
 * @description
 * # ResolucionposgradohcpCtrl
 * Controller of the cdveApp
 */
angular.module('cdveApp')
  .controller('ResolucionposgradohcpCtrl', function (vinculacion_request,$routeParams) {
    var self = this;
