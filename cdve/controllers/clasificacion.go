...
// @Param	body		body 	models.Clasificacion	true		"body for Clasificacion content"
// @Success 201 {int} models.Clasificacion
// @Failure 403 body is empty
// @router / [post]
func (c *ClasificacionController) Post() {
	var v models.Clasificacion
...
// @Success 200 {object} models.Clasificacion
// @Failure 403 :id is empty
// @router /:id [get]
func (c *ClasificacionController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *ClasificacionController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// @router /:id [put]
func (c *ClasificacionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *ClasificacionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
